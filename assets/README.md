...
| --- | --- | --- | --- |
| `hero/agent-ui-loop-demo.gif` | 16:9 workflow (UI left, verification right) | Real Chromium shots. Fail frames use a capture wider than 390px so the overflowing CTA stays in-frame; a red 390px box marks the real viewport. | Hero |
